...
export const FacebookButton = () => {
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-20 right-4 sm:bottom-24 sm:right-6 z-50 bg-[#1877F2] text-white p-3 sm:p-4 rounded-full shadow-2xl hover:scale-110 transition-transform flex items-center justify-center"
      title="Visitez notre page Facebook"
      aria-label="Page Facebook officielle"
    >
      <svg className="w-7 h-7 sm:w-8 sm:h-8 fill-current" viewBox="0 0 320 512" xmlns="http://www.w3.org/2000/svg">
